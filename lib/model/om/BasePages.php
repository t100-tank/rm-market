...
abstract class BasePages extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the is_301redirect field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $is_301redirect;

	/**
	 * The value for the old_link field.
	 * @var        string
	 */
	protected $old_link;
	...
	/**
	 * The value for the breadcrumb field.
	 * @var        string
	 */
	...
	/**
	 * Get the [is_301redirect] column value.
	 * 
	 * @return     boolean
	 */
	public function getIs301redirect()
	{
		return $this->is_301redirect;
	}

	/**
	 * Get the [old_link] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Get the [breadcrumb] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [is_301redirect] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Pages The current object (for fluent API support)
	 */
	public function setIs301redirect($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->is_301redirect !== $v || $this->isNew()) {
			$this->is_301redirect = $v;
			$this->modifiedColumns[] = PagesPeer::IS_301REDIRECT;
		}
	...
	/**
	 * Set the value of [old_link] column.
	 * 
	 * @param      string $v new value
	 * @return     Pages The current object (for fluent API support)
	 */
	public function setOldLink($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->old_link !== $v) {
			$this->old_link = $v;
			$this->modifiedColumns[] = PagesPeer::OLD_LINK;
		}
	...
	/**
	 * Set the value of [breadcrumb] column.
	 * 
	 * @param      string $v new value
	 * @return     Pages The current object (for fluent API support)
	 */
	public function setBreadcrumb($v)
	{
		...
		if ($this->breadcrumb !== $v) {
			$this->breadcrumb = $v;
			$this->modifiedColumns[] = PagesPeer::BREADCRUMB;
		}
	...
	public function setH1($v)
	{
		...
		if ($this->h1 !== $v) {
			$this->h1 = $v;
			$this->modifiedColumns[] = PagesPeer::H1;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PagesPeer::H1)) $criteria->add(PagesPeer::H1, $this->h1);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBreadcrumb($this->breadcrumb);
