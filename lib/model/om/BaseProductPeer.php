...
abstract class BaseProductPeer {
	...
	/** the column name for the ANALOG_UID field */
	const ANALOG_UID = 'product.ANALOG_UID';
	...
	/** the column name for the DISTRIB_PRICE field */
	const DISTRIB_PRICE = 'product.DISTRIB_PRICE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CategoryId', 'Amount', 'Uid', 'AnalogUid', 'Slug', 'Name', 'DistribPrice', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'categoryId', 'amount', 'uid', 'analogUid', 'slug', 'name', 'distribPrice', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CATEGORY_ID, self::AMOUNT, self::UID, self::ANALOG_UID, self::SLUG, self::NAME, self::DISTRIB_PRICE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'category_id', 'amount', 'uid', 'analog_uid', 'slug', 'name', 'distrib_price', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CategoryId' => 1, 'Amount' => 2, 'Uid' => 3, 'AnalogUid' => 4, 'Slug' => 5, 'Name' => 6, 'DistribPrice' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'categoryId' => 1, 'amount' => 2, 'uid' => 3, 'analogUid' => 4, 'slug' => 5, 'name' => 6, 'distribPrice' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CATEGORY_ID => 1, self::AMOUNT => 2, self::UID => 3, self::ANALOG_UID => 4, self::SLUG => 5, self::NAME => 6, self::DISTRIB_PRICE => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'category_id' => 1, 'amount' => 2, 'uid' => 3, 'analog_uid' => 4, 'slug' => 5, 'name' => 6, 'distrib_price' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProductPeer::AMOUNT);
		$criteria->addSelectColumn(ProductPeer::UID);
		$criteria->addSelectColumn(ProductPeer::ANALOG_UID);
		$criteria->addSelectColumn(ProductPeer::SLUG);
		$criteria->addSelectColumn(ProductPeer::NAME);
		$criteria->addSelectColumn(ProductPeer::DISTRIB_PRICE);
	}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(CarProductPeer::PRODUCT_ID, $obj->getId());
