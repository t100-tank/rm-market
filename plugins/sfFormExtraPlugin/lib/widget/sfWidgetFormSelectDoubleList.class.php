...
EOF
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    $associatedWidget = new sfWidgetFormLiSelect(array('multiple' => true, 'choices' => $associated), array('size' => $size, 'class' => $this->getOption('class_select').'-selected'));
    $unassociatedWidget = new sfWidgetFormLiSelect(array('multiple' => true, 'choices' => $unassociated), array('size' => $size, 'class' => $this->getOption('class_select')));
...
//      '%unassociate%'        => sprintf('<a href="#" onclick="%s">%s</a>', 'sfDoubleList.move(\''.$this->generateId($name).'\', \'unassociated_'.$this->generateId($name).'\'); return false;', $this->getOption('unassociate')),
      '%associate%'          => sprintf('%s', $this->getOption('associate')),
      '%unassociate%'        => sprintf('%s', $this->getOption('unassociate')),
