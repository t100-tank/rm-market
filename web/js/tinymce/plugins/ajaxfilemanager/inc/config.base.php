...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../'.sfConfig::get('app_uploads_dir')); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../'.sfConfig::get('app_uploads_dir'));	//accept relative path only
