...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '..'.sfConfig::get('sf_upload_dir_name').sfConfig::get('sf_files_dir_name').PATH_ADDITION); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '..'.sfConfig::get('sf_upload_dir_name').sfConfig::get('sf_files_dir_name').PATH_ADDITION);	//accept relative path only
